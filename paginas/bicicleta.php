    ...
    <div class="row justify-content-md-center" >
        ...
        <div class="col-9 col-md-8 border border-primary border-3 " style="height: 80vh; overflow: scroll; ">
            <div class="container-fluid bg-light p-1 my-1" style="height: 8vh;">
                <h2 class="text-capitalize">Mis Bicicletas</h2>
            </div>
            <hr>
            <!--Contenido: -->
            <div class="row justify-content-center">
                <div class="col-md-6 my-1">
                    <center>
                    <img src="https://thumbs.dreamstime.com/b/icono-simple-de-la-bicicleta-l%C3%ADneas-negras-dibujo-bici-en-el-backgroun-blanco-124595370.jpg" alt="W3Schools.com" style="width:300px;height:300px;"></center>
                    <hr>
                    <div class="d-grid">
            ...
            <!--Contenido final: -->
            <div class="d-grid">
                    <button type="submit" name="enviar" value="Ingresar" class="btn btn-dark" onclick="location.href = './registroBici.php'">Registrar una nueva bicicleta</button>
                    </div>
            <p> </p>
            <p> </p>
            <p> </p>
